...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("devicemodels"):
		...
		// Group=reliablesync.kubeedge.io, Version=v1alpha1
	case reliablesyncsv1alpha1.SchemeGroupVersion.WithResource("clusterobjectsyncs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Reliablesync().V1alpha1().ClusterObjectSyncs().Informer()}, nil
	case reliablesyncsv1alpha1.SchemeGroupVersion.WithResource("objectsyncs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Reliablesync().V1alpha1().ObjectSyncs().Informer()}, nil
